...
<body class="homeBody">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-12 text-center">
                    <div class="aboutCont">
                        <h2>Your golden visa made easy with Crowd</h2>
                        <h1>Invest From Anywhere In The World And <br>
                            <span>Secure Your UAE Golden Visa</span>
                        </h1>
                        <p>Enjoy a host of benefits by investing a minimum of AED 2,000,000<br> (approx. USD 545,000)
                            through
                            our platform.
                        </p>
                        <div class="banBtn">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="vid-Cont">
                        <figure>
                            <img src="assets/images/vidImg.png" class="img-fluid w-100" alt="">
                            <div class="overlay">
    ...
    <section class="pass-sect">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="subtitle">What is a Golden Visa?</h3>
                    <h2 class="sectionheading">Your <span class="yellow">Passport To</span> <span>Freedom</span>
                    </h2>
                    <p class="sectParagraph">90% of the worlds millionaires made their fortunes through real estate, but
                        it’s highly inaccessible, illiquid, and<br> complicated - that’s where we come in!
                    </p>
                </div>
            </div>
            <div class="row justify-content-between">
                <div class="col-md-3">
                    <div class="passCont">
                        <figure>
                            <img src="assets/images/dot.png" class="img-fluid" alt="">
                        </figure>
    ...
    <section class="way-sect">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="wayCont">
                        <h2 class="sectionheading">The Smartest<br> <span class="yellow">Way To Get Your</span><br>
                            <span>Golden Visa</span>
                        </h2>
                        <p class="sectParagraph">Join the growing Fintech revolution in the global financial landscape
                            and
                            capitalise on Dubai's exceptional real estate potential with Stake's innovative
                            collaboration
                            with
                            DIFC.
                        </p>
                ...
                <div class="col-md-6 text-center">
                    <div class="wayContent">
                        <div class="wayimg">
                            <figure>
                                <img src="assets/images/img-1.png" class="img-fluid" alt="">
                            </figure>
                            <h2>Enhanced safety and security</h2>
                            <p>Get a 10-year renewable residency permit, allowing you to live and work without the
                                hassle of
                                frequent visa renewals</p>
                        </div>
    ...
    <section class="member-sect">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="subtitle">What is a Golden Visa?</h3>
                    <h2 class="sectionheading">Automatically <span class="yellow">Unlock Elite</span>
