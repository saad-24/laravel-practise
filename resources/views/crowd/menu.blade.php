                ...
                <div class="col-md-12">
                    <div class="navigation">
                        <nav class="navbar navbar-expand-lg navbar-light ">
                            <a class="navbar-brand" href="#"><img src="{{ asset('public/images/logo.png') }}" class="img-fluid"
                                    alt=""></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul class="navbar-nav mx-auto">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="{{ asset('resources/views/crowd/properties.blade.php') }}">Properties</a>
                                    </li>
                                    <li class="nav-item">
