            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="prop-det-cont">
                        <div class="first-image">
                            <figure>
                                <img src="assets/images/properties/img-1.jpeg" class="img-fluid" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="second-image">
                        <figure>
                            <img src="assets/images/properties/img-2.jpeg" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="second-image">
                        <figure>
                            <img src="assets/images/properties/img-3.jpeg" class="img-fluid" alt="">
                        </figure>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="second-image">
                        <figure>
                            <img src="assets/images/properties/img-4.jpeg" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="second-image">
                        <figure>
                            <img src="assets/images/properties/img-5.jpeg" class="img-fluid" alt="">
                        </figure>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-5">
                    <div class="prop-price-fixed">
                        <div class="prop-price-card">
                            ...
                            <h3><sub>AED</sub> 1,611,000</h3>
                            <progress id="file" value="85" max="100"> 85% </progress>

                            <div class="funded">
                                <h3>82% funded</h3>
                                <h3>AED 339,168 available</h3>
                            </div>

                            <div class="funded fundedTime">
                                <h3><span>411</span> investors</h3>
                    ...
                    <div class="howCard howCardNew">
                        ...
                        <div class="hwcBody">
                            ...
                            <div class="downCard">
                                ...
                                <h6>
                                    <figure><img src="assets/images/prog.png" class="img-fluid" alt="">
                                    </figure> 85% Sold
                                </h6>
                            </div>
                            <ul>
