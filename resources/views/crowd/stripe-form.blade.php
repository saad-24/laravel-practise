...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form  action="{{route('stripe-payment')}}"  data-cc-on-file="false" data-stripe-publishable-key="pk_test_0rY5rGJ7GN1xEhCB40mAcWjg" name="frmStripe" id="frmstripe" method="post">
                {{ csrf_field() }}
                <div class="row">
