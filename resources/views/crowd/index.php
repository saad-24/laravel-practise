...
<body class="homeBody">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5">
                    <div class="banCont">
                        ...
                        <h1>Real Estate</h1>
                        <p>Digitally invest in prime rental properties from only AED 500 (USD 136), no matter where you
                            are
                            in the world!</p>
                ...
                <div class="col-md-6">
                    <div class="banCont">
                        <img src="assets/images/ban-img.png" class="img-fluid w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <img src="assets/images/text.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="how-sect">
        <img src="assets/images/howElm.png" class="img-fluid howElm" alt="">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="howCont">
    ...
    <section class="mobile-sect">
        <img src="assets/images/mobImg.png" class="img-fluid mobImg" alt="">
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-6">
                    <div class="mobCont">
                        ...
                        <div class="screenImg">
                            <img src="assets/images/screen.png" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p class="sectParagraph">Crowd was built to empower everyone to own and build wealth through real
                        estate
                    </p>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="howCard">
                        ...
                        <div class="hwcBody">
                            ...
                            <div class="downCard">
                                ...
                                <h6>
                                    <figure><img src="assets/images/prog.png" class="img-fluid" alt=""></figure> 85%
                                    Sold
                                </h6>
                            </div>
                            <ul>
                ...
                <div class="col-md-4">
                    <div class="monRentHead">
                        <div class="monRental">
                            <figure>
                                <img src="assets/images/mn-1.png" class="img-fluid" alt="">
                            </figure>
                        ...
                        <div class="monRental">
                            <figure>
                                <img src="assets/images/mn-2.png" class="img-fluid" alt="">
                            </figure>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="invCard">
                        <figure>
                            <img src="assets/images/inv-1.png" class="img-fluid" alt="">
                        </figure>
                ...
                <div class="col-md-6">
                    <div class="testSlider">
                        <div class="testimonials">
                            ...
                            <p>Our team of property professionals combine a data driven valuation and analysis process
                                with
                                over
                                20 years of leadership experience at the top real estate companies in Dubai, to source
                                the
                                best
                                rental </p>
                            <div class="nameDiv">
                                ...
                                <figure>
                                    <img src="assets/images/trustpilot.png" class="img-fluid" alt="">
                                </figure>
                            </div>
                        </div>
                        <div class="testimonials">
            ...
            <!-- <div class="row align-items-center mt-5">
                <div class="col-md-6">
                    <div class="calForm">
                        ...
                        <form>
                            ...
                            <div class="form-row mt-3">
                                <div class="col">
                                    <p>All projected values are before any property costs and platform fees, and based
                                        on a
                                        5-year holding period. We expect the asset value to grow 30% over the next 5
                                        years.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="cal-hcont">
                        ...
                        <img src="assets/images/progress.png" class="img-fluid w-100    " alt="">
                    </div>
                </div>
            </div> -->
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="calForm calFormInn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="input-group col-md-12">
                                        ...
                                        <input class="form-control text-center" id="initial_deposit" type="range"
                                            name="initial_deposit" min="100" max="1000000" step="100" value="$5000"
                                            data-value="5000">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="input-group col-md-12">
                                        ...
                                        <input class="form-control text-center" id="contribution_amount" type="range"
                                            name="contribution_amount" min="0" max="10000" step="1" value="$100"
                                            data-value="100">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="input-group col-md-12">
                                        ...
                                        <input class="form-control text-center" id="estimated_return" type="range"
                                            name="estimated_return" min="0" max="50" step="0.25" value="5.00%"
                                            data-value="5.00" data-append="%">
                        ...
                        <p>All projected values are before any property costs and platform fees, and based on a 5-year
                            holding period. We expect the asset value to grow 30% over the next 5 years.</p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p class="sectParagraph">With over 20 years of experience leading major real estate companies in
                        Dubai,
                        we utilize our<br> expertise and network to find properties with the greatest investment
                        potential
                        for
                        you.
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="howCard howCardNew">
                        <div class="hwcHead">
                            <figure>
                                <img src="assets/images/mon-1.png" class="img-fluid w-100" alt="">
                            </figure>
                        </div>
                        <div class="hwcBody">
                            <h2>1 Bedroom in Burj Khalifa</h2>
                ...
                <div class="col-md-4">
                    <div class="howCard howCardNew">
                        <div class="hwcHead">
                            <figure>
                                <img src="assets/images/mon-2.png" class="img-fluid w-100" alt="">
                            </figure>
                        </div>
                        <div class="hwcBody">
                            <h2>1 Bedroom in Burj Khalifa</h2>
                ...
                <div class="col-md-4">
                    <div class="howCard howCardNew">
                        <div class="hwcHead">
                            <figure>
                                <img src="assets/images/mon-3.png" class="img-fluid w-100" alt="">
                            </figure>
                        </div>
                        <div class="hwcBody">
                            <h2>1 Bedroom in Burj Khalifa</h2>
    ...
    <section class="best-sect">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="sectionheading">Real Estate Combines<br><span class="yellow">The Best Of All
                            Asset</span><br>
                        <span>Classes</span>
                    </h2>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="bestCard">
                        <figure>
                            <img src="assets/images/bs-1.png" class="img-fluid" alt="">
                        </figure>
                        <h3>Capital appreciation</h3>
                        <p>In addition to monthly passive income, real estate appreciates in value like equities,
                            creating
                            long </p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="bestCard">
                        <figure>
                            <img src="assets/images/bs-2.png" class="img-fluid" alt="">
                        </figure>
                ...
                <div class="col-md-3">
                    <div class="bestCard">
                        <figure>
                            <img src="assets/images/bs-3.png" class="img-fluid" alt="">
                        </figure>
                ...
                <div class="col-md-3">
                    <div class="bestCard">
                        <figure>
                            <img src="assets/images/bs-4.png" class="img-fluid" alt="">
                        </figure>
